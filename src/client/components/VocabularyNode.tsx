...
export interface VocabularyNodeData extends Record<string,unknown>{label:string;meaningVi:string;ipa:string;nodeType:"root"|"branch"|"vocabulary";color:string;status:string;onSpeak?:(text:string)=>void;onAddNote?:(nodeId:number)=>void;nodeId:number}
